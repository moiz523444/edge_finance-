    ...
    <View style={styles.container}>
      ...
      <SafeAreaView style={{ flex: 1 }}>
        <ScrollView contentContainerStyle={styles.content}>
          ...
          <View style={[styles.card, { borderColor: PRIMARY + '30' }]}>
            <Ionicons name="stats-chart-outline" size={45} color={PRIMARY} />
            <Text style={styles.cardTitle}>Monthly Analysis</Text>
            <Text style={styles.cardDesc}>View your spending and repayment reports.</Text>
          </View>
        </ScrollView>
      </SafeAreaView>
    </View>
